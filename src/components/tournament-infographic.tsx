  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4">
      ...
      <div className="bg-[#1a0f2e] border border-[#2815d3]/30 rounded-lg p-4 mb-4">
        <div className="flex flex-col items-center gap-4 sm:flex-row sm:items-center sm:justify-between text-center">
          <div className="flex-1 min-w-0">
            <div className="text-white font-bold text-sm">128</div>
            <div className="text-foreground/60 text-xs">Players</div>
          </div>

          {/* Arrow between steps: vertical on mobile, horizontal on desktop */}
          <ArrowRight className="w-4 h-4 text-[#a83acd] flex-shrink-0 rotate-90 sm:rotate-0" />
      ...
      {/* Format note */}
      <p className="text-center text-xs text-foreground/60 mt-3">Double elimination whole tournament, best of 1 matches till playoffs</p>
    </div>
  )
}
