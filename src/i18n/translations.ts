...
const translations = {
  pl: {
    ...
    tournaments: {
      ...
      activeTitle: 'Turnieje',
      activeSubtitle: 'Lista aktywnych turniejów i wybranych zakończonych wydarzeń.',
      regulationsCta: 'Regulamin sezonu',
      empty: 'Aktualnie brak turniejów do wyświetlenia. Wróć później po nowe informacje.',
      registrationLabel: 'Rejestracja',
      startLabel: 'Start turnieju',
      statusLabel: 'Status',
  ...
  en: {
    ...
    tournaments: {
      ...
      activeTitle: 'Tournaments',
      activeSubtitle: 'Active tournaments and selected completed events.',
      regulationsCta: 'Season rules',
      empty: 'No tournaments are available to display right now. Check back later for updates.',
      registrationLabel: 'Registration',
      startLabel: 'Tournament start',
      statusLabel: 'Status',
